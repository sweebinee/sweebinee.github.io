...
- **Available to chat**<br/>오른쪽에서 왼쪽으로 스와이프하면 지금 활동중이거나 최근에 활동했던 팔로워들을 볼 수 있다. 활동중인 사람들은 어떤 방에 들어 있는지도 함께 확인할수 있으며 프로필을 눌러서 같은 방에 바로 조인할 수도 있다. 참고로 옆에 있는 `+Room :lock:` 은 DM기능이 아니고 1:1 갠톡과 비슷한 기능이다. 잘못눌렀다간 천년의 어색한 시간을 보낼 수 있으니 조심하자. 

### <span style="background-color:#d4fdf2">- 초대장에 대한 진실은? -</span>
아직까지 클럽하우스는 초대제로 운영되고 있다. 처음에 가입하면 초대장을 2개 준다고 알려져 있는데, 지금 사용자가 폭발적으로 늘어 어떤 사람들은 하나도 못받고 시작한다고 한다. 딱히 운영진이 공지한 기준은 없지만 사람들의 이야기를 들어보면 초대장의 수에 대한 썰은 다음과 같다.
- 시작할때 초대장을 기본으로 2개 정도 준다. (하지만 아예 못받는 사람도 있다.)
- moderator나 speaker로 활동하면 더 많은 초대장이 생긴다. 
- 팔로워 수와는 상관이 없는것 같다.

나는 그래서 처음에는 초대장이 2개였는데, 3일정도 되니까 5개로 늘었다. 초대를 원하는 사람은 이메일로 정중히 요청 바란다. 
<p align="center"><img src="https://user-images.githubusercontent.com/43258282/108361533-f7228580-7235-11eb-9221-8f6aa85c6385.PNG" alt=igot5invites width="70%" height="70%"></p>

이건 가입이후에 다른 사람들을 초대할때도 마찬가지인데, 누군가는 내가 초대해서 그 사람이 클하에 들어오게 된다면 초대 받은 사람 프로필 아래에 `Nomitaed by 내이름` 이렇게 들어가게 된다. 이렇게 돼도 괜찮은 사람만 초대해주도록 하자. 그리고 다시한번 말하지만 클하는 **성인전용**이다
